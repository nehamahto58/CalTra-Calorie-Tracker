...
public class RegisterActivity extends AppCompatActivity {
    ...
    public void CheckEditTextStatus(){
        ...
        if(TextUtils.isEmpty(NameHolder) || NameHolder.length() < 3 || !android.util.Patterns.EMAIL_ADDRESS.matcher(EmailHolder).matches() || TextUtils.isEmpty(EmailHolder) || TextUtils.isEmpty(PasswordHolder)|| PasswordHolder.length() < 4 || PasswordHolder.length() > 10){
